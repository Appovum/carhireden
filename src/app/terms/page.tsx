// ═══════════════════════════════════════════════════════════════════
// CouponPilot — Public Terms of Service Page
// Route: /terms
...
export async function generateMetadata() {
  const setting = await db.setting.findUnique({ where: { key: "page_terms" } });
  const data = setting ? JSON.parse(setting.valueJson) : DEFAULT_PAGES.terms;
  return {
    title: data?.metaTitle || DEFAULT_PAGES.terms.metaTitle,
    description: data?.metaDescription || DEFAULT_PAGES.terms.metaDescription,
  };
}
...
export default async function TermsPage() {
  ...
  const page = { ...DEFAULT_PAGES.terms, ...dbData };
